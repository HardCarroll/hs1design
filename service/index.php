...
<head>
  ...
  <title>我们能做什么？湖南炉石空间设计丨专注于餐厅空间设计、酒店空间设计、KTV空间设计</title>
      ...
      <div class="container-fluid wrapper" id="process">
        ...
        <section class="inner row process-list">
          <div class="col-xs-12 col-sm-6 col-md-3 process-list-item">
            <div class="panel panel-default">
              <div class="panel-heading">
                <span class="glyphicon glyphicon-bookmark" data-sn="1"></span>
                <h3 class="panel-title">项目前期</h3>
              </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3 process-list-item">
            <div class="panel panel-default">
              <div class="panel-heading">
                <span class="glyphicon glyphicon-bookmark" data-sn="2"></span>
                <h3 class="panel-title">设计方案</h3>
              </div>
              <div class="panel-body">
                <ul>
                  <li>平面方案</li>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3 process-list-item">
            <div class="panel panel-default">
              <div class="panel-heading">
                <span class="glyphicon glyphicon-bookmark" data-sn="3"></span>
                <h3 class="panel-title">深化方案</h3>
              </div>
              <div class="panel-body">
                <ul>
                  <li>施工图</li>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3 process-list-item">
            <div class="panel panel-default">
              <div class="panel-heading">
                <span class="glyphicon glyphicon-bookmark" data-sn="4"></span>
                <h3 class="panel-title">后期服务</h3>
              </div>
              <div class="panel-body">
                <ul>
                  <li>技术交底</li>
