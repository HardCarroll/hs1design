$(function(){
  ...
  $("#landmark .arrow.left span").off("click").on("click", function() {
    $("#landmark ul li").last().prependTo($("#landmark ul"));
  });
  $("#landmark .arrow.right span").off("click").on("click", function() {
    $("#landmark ul li").first().appendTo($("#landmark ul"));
  });
  ...
  if ($(window).width() < 768) {
    ...
    $("#landmark ul li").width($("#landmark").width() / 3);
    $("#landmark ul").width($("#landmark").width() / 3 * $("#landmark ul li").length);
  }
  else {
    $("#pageFooter").css({paddingBottom: "0"});
    $("#asidebar_tools").css({bottom: "65px"});

    $("#landmark ul li").width($("#landmark").width() / 6);
    $("#landmark ul").width($("#landmark").width() / 6 * $("#landmark ul li").length);
  }
